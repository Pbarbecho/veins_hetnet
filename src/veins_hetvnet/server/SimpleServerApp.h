...
#include "veins/modules/heterogeneous/application/SimpleApp.h"
...
class SimpleServerApp: public ApplicationBase {
	protected:
		...
		std::string APP_Server_filename;
	...
	public:
		...
		virtual void CaptureMSG(std::string node, std::string state,std::string nodeid, int type, std::string source, std::string destination, int msgID);
